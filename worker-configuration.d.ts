/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 9d2c9f40e6ff7d95e6b6c0460b3b007f)
// Runtime types generated with workerd@1.20260420.1 2026-04-01 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		...
		GITHUB_OWNER: string;
		GITHUB_REPO: string;
		DOQueueHandler: DurableObjectNamespace /* DOQueueHandler */;
		DOShardedTagCache: DurableObjectNamespace /* DOShardedTagCache */;
		BucketCachePurge: DurableObjectNamespace /* BucketCachePurge */;
		WORKER_SELF_REFERENCE: Fetcher /* highlights */;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AUTH_SECRET" | "AUTH_GOOGLE_ID" | "AUTH_GOOGLE_SECRET" | "NEXTAUTH_URL" | "DRIVE_GOOGLE_CLIENT_ID" | "DRIVE_GOOGLE_CLIENT_SECRET" | "GITHUB_PAT" | "GITHUB_OWNER" | "GITHUB_REPO">> {}
}
